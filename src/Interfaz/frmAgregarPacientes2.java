 ...
 */
public class frmAgregarPacientes2 extends javax.swing.JInternalFrame {

    
    MySql sql = new MySql();
    validacion va = new validacion();
    public frmAgregarPacientes2() {
        initComponents();
    ...
    private void initComponents() {
        ...
        txttelefonoEm.setFont(new java.awt.Font("Trebuchet MS", 0, 20)); // NOI18N
        ...
        txtapellido.setFont(new java.awt.Font("Trebuchet MS", 0, 20)); // NOI18N
        ...
        txtdireccion.setFont(new java.awt.Font("Trebuchet MS", 0, 20)); // NOI18N
        ...
        txtNidentida.setFont(new java.awt.Font("Trebuchet MS", 0, 20)); // NOI18N
        ...
        txtprocedencia.setFont(new java.awt.Font("Trebuchet MS", 0, 20)); // NOI18N
        ...
        txttelefono.setFont(new java.awt.Font("Trebuchet MS", 0, 20)); // NOI18N
        ...
        txtnombreEm.setFont(new java.awt.Font("Trebuchet MS", 0, 20)); // NOI18N
        ...
        txtNcuenta.setFont(new java.awt.Font("Trebuchet MS", 0, 20)); // NOI18N
        ...
        txtcorreo.setFont(new java.awt.Font("Trebuchet MS", 0, 20)); // NOI18N
    ...
    void obtenerVariables() {
        ...
        carrera = String.valueOf(sql.valor("select idcarreras from carreras where carreras='"
                + cmbcarrera.getSelectedItem().toString() + "'"));

    }
    private void btnguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardarActionPerformed
            obtenerVariables();
        if (!sql.versiesta("select nocuenta from persona where nocuenta=" + cuenta)) {
          
            sql.EjecutarConsultas("select insertar_paciente(" + cuenta + ", '" + identidad + "','" + nombre + "','"
                    + apellido + "','" + direccion + "','" + correo + "'," + telefono + ",'" + va.getfecha(cmbdia, cmbmes, cmbaño) + "'," + sexo
                    + "," + estadoCivil + ",'" + procedencia + "','" + nombreEm + "'," + telefonoEm + "," + carrera + ")");
        } else {
    ...
    private void btncancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncancelarActionPerformed
        ...
        System.out.println("" + sql.versiesta("select nocuenta from persona where nocuenta=" + cuenta));
    ...
    void bloquearInmodificable(boolean b) {
        ...
        this.cmbdia.setEnabled(b);
        this.cmbmes.setEnabled(b);
        this.cmbaño.setEnabled(b);
        this.txtcorreo.setEnabled(b);
    }
